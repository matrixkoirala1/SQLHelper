...
namespace LogicLayers.SQLHelper
{
    public partial class SQLHandler 
    {
        ...
        public void ExecuteAsTable(string StroredProcedureName, List<KeyValuePair<string, object>> ParaMeterCollection, bool isStructured)
        {
            SqlConnection SQLConn = new SqlConnection(this._connectionString);
            try
            {
